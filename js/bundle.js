...
function slider({container,slide,nexArrow,prevArrow,totalCounter,currentCounter,wrapper,field}) {
  ...
  totalSlide.innerHTML = (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getZero)(slides.length);
  showSlides(slideIndex);
  ...
  function showSlides(i) {
    ...
    currentSlide.innerHTML = (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getZero)(slideIndex);
  }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function tabs(tabsSelector,tabsContentAll,tabsParentSelector,activeClass) {
  let tabs = document.querySelectorAll(tabsSelector),
    tabsContent = document.querySelectorAll(tabsContentAll),
